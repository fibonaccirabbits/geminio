...
# run stuff
training_dirs = os.listdir('.')
training_dirs = [item for item in training_dirs if 'training' in item and '1OB1' in item]
training_dirs = sorted(training_dirs, reverse=True)
for training_dir in training_dirs:
    model_tag = '_'.join(training_dir.split('_')[:-2])
